...
import (
	...
	core "chainmaker.org/chainmaker/vm-docker-go/v2/vm_mgr/module/core"
...
func (m *MockScheduler) AddTxCallContractElapsedTime(txId string, sysCallElapsedTime *core.SysCallElapsedTime) {
	m.ctrl.T.Helper()
...
func (m *MockScheduler) AddTxSysCallElapsedTime(txId string, sysCallElapsedTime *core.SysCallElapsedTime) {
	m.ctrl.T.Helper()
...
func (m *MockScheduler) GetTxElapsedTime(txId string) *core.TxElapsedTime {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTxElapsedTime", txId)
	ret0, _ := ret[0].(*core.TxElapsedTime)
	return ret0
}
