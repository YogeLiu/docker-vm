...
const (
	ContractNameTest    = "DockerGoCal00"
...
func InitContextTest(runtimeType commonPb.RuntimeType) (*commonPb.Contract, *TxContextMockTest) {
...
func (s *TxContextMockTest) CallContract(contract *commonPb.Contract, method string, byteCode []byte,
	...
	// s.currentDepth = s.currentDepth - 1
	return nil, commonPb.TxStatusCode_SUCCESS
}
